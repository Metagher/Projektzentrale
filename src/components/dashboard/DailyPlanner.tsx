  ...
  return (
    <section className="daily-planner">
      <header className="daily-planner-head">
        ...
        <div className="daily-planner-switch"><button className={day === 'today' ? 'active' : ''} onClick={() => setDay('today')}>Heute</button><button className={day === 'tomorrow' ? 'active' : ''} onClick={() => setDay('tomorrow')} title={`Nächster Arbeitstag: ${nextDayLabel}`}>Nächster Arbeitstag</button></div>
      </header>
